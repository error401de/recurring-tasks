...
try:
    ...
    for i in config.sections():
        ...
        if taskType == 'daily':
            ...
            logger.info("Everything is OK! :D I'll remember you \"{}\" every day ".format(message))
        ...
        if taskType == 'monthly':
            for j in extract_days(i).split(','):
                ...
                if day == j:
                    message = extract_message(i)
                    logger.info("Everything is OK! :D I'll remember you \"{}\" every {} of the month ".format(message, j))
                    sendMail.sendNotification(i, message)
